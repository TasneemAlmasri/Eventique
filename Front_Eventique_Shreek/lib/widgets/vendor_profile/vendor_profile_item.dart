...
class VendorProfileItem extends StatefulWidget {
  final String title;
  String userInfo;
  ...
  @override
  _VendorProfileItemState createState() => _VendorProfileItemState();
}

class _VendorProfileItemState extends State<VendorProfileItem> {
    ...
    return Container(
      ...
      child: Center(
        child: ListTile(
          ...
          trailing: !(widget.title == 'Password' || widget.title == 'Email')
              ? IconButton(
                  icon: Icon(
                    Icons.edit,
